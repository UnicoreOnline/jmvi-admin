...
if ($id != null) {
    ...
    $lawyer = $controller->getLawyerByLawyerId($id);
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-plaintext" placeholder="Lawyer Full Name" name="name" id="name"
                                               required value="<?php echo $lawyer->name; ?>">                              
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-plaintext" placeholder="Company Name" name="company_name" id="company_name"
                                               required value="<?php echo $lawyer->company_name; ?>">                              
                                    </div>
                                </div>                                
                                <div class="form-group row">
                                    <label for="address" class="col-sm-2 col-form-label">Company Address</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" placeholder="Company Address" name="address" id="address" required><?php echo $lawyer->address; ?></textarea>                                                                  
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-plaintext" placeholder="Website" name="website" id="website"
                                               required value="<?php echo $lawyer->website; ?>">                              
                                    </div>
                                </div>                                
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-plaintext" placeholder="Contact Number" name="contact_no" id="contact_no"
                                               required value="<?php echo $lawyer->contact_no; ?>">                              
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control form-control-plaintext" placeholder="Email Address" name="email" id="email"
                                               required value="<?php echo $lawyer->email; ?>">                              
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-plaintext" placeholder="Whatsapp Number" name="whatsapp_no" id="whatsapp_no"
                                               required value="<?php echo $lawyer->whatsapp_no; ?>">                              
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="main-image-preview_product">
                                            <div class="photo_preview_div row">
                                                <?php if(!empty($lawyer->photo_url)){ ?>
                                                    <?php $photo_Url = Constants::ROOT_URL.Constants::IMAGE_UPLOAD_DIR.'/'.$lawyer->photo_url;   ?>
                                                    <div class="image_preview_div2 col-sm-2" id="0_image_preview_div">
                                                        <div class="img-box"> <img width="100%" src="<?= $photo_Url ?>" id="banner_image_0" class="added_deal_image product_img"> </div>
                                                        <div class="img-action">
                                                            <span class="delete-image btn btn-danger mr_top_10 delete-image" item-index="0">
                                                                <i class="fa fa-minus" aria-hidden="true" id="delete-0-image" data-input-index="0" rel-data-id="thumb-input-fa-561276_Lighthouse.jpg" item-rel="product" item-index="0"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                            <div class="col-sm-2 row file_add_box" style="<?= !empty($lawyer->photo_url) ? 'display:none':'' ?>">
...
<?php require_once 'footer_js.php'; ?>
        ...
        <script>
            function checkInput() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'lawyer_update.php?<?= $_SERVER['QUERY_STRING'] ?>',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: formData,
