        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Real Estate  <?php if($realestate->status == 0) { echo "(For Rent)"; }elseif ($realestate->status == 1) { echo "(For Salee)"; } ?></h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<form action="javascript:void(0);" method="POST" class="form_add">
                                ...
                                <div class="form-group row">                                    
                                    <label class="col-sm-2 col-form-label"><?= $realestate->status == 1 ? 'Price':'Price per month'  ?></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Price/Month" required name="price_per_month" value="<?php echo $realestate->price_per_month; ?>">
                                    </div>
                                </div>
                                */ ?>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Property Size (Sq. Ft)" required name="sqft" value="<?php echo $realestate->sqft; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Contact for Price</label>
                                    <div class="col-sm-10">                                        
                                        <input type="checkbox" class="" name="is_contact_price" <?= $realestate->is_contact_price == 1 ? 'checked' : ''?> value="1">
                                    </div>
                                </div>                                
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" style="width:100%;" name="status">
                                            ...
                                            <option <?php echo $realestate->status == 0 ? "selected" : ""; ?> value="0">For Rent</option>
                                            <option <?php echo $realestate->status == 1 ? "selected" : ""; ?> value="1">For Sale</option>
                                            <option <?php echo $realestate->status == 2 ? "selected" : ""; ?> value="2">Sold</option>
                                            <option <?php echo $realestate->status == 3 ? "selected" : ""; ?> value="3">Auction</option>
                                        </select>
                                    </div>
                                </div>      
                                ...
                                <p>
                                    ...
                                    <a class="btn btn-info" href="realestates.php?stype=<?php echo $realestate->status; ?>" role="button">Cancel</a>
                                </p>
                            </form> 
                        </div>                        
            ...
            <script>
                                        ...
                                        function checkInput() {
                                            ...
                                            $.ajax({
                                                type: 'POST',                                                
                                                url: 'realestate_update.php?<?= $_SERVER['QUERY_STRING'] ?>',
                                                cache: false,
                                                contentType: false,
                                                processData: false,
                                                data: formData,
                                                ...
                                                {
                                                    window.location.href = 'realestates.php?stype=<?= $realestate->status ?>';
                                                },
