...
class Extras
{
    ...
    function encryptQuery3($keySalt, $qry1, $val1, $qry2, $val2, $qry3, $val3, $landing_page){

        //making query string
        $qryStr = "$qry1=".$val1."&$qry2=".$val2."&$qry3=".$val3;   
    ...
    function decryptQuery3($keySalt, $qryStr){
        ...
        if($ampCount == 3) {
            $equal1 = explode('=', $amp[0]);
            $equal2 = explode('=', $amp[1]);
            $equal3 = explode('=', $amp[2]);

            $equalCount1 = count($equal1);
            $equalCount2 = count($equal2);
            $equalCount3 = count($equal3);

            if($equalCount1 == 2 && $equalCount2 == 2 && $equalCount3 == 2) {
                $val = array();
                $val[0] = $equal1[1];
                $val[1] = $equal2[1];
                $val[2] = $equal3[1];
