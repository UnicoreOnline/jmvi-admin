                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="javascript:void(0);" method="POST" class="form_add">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><?= $ptype == 1 ? 'Price':'Price per month'  ?></label>
                                    <div class="col-sm-10">
                                ...
                                */ ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">                                        
                                        <input type="checkbox" class="" name="is_contact_price"  value="1">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="status_id" style="width:100%;" name="status">
                                            <option value="">Select Status</option>
                                            <option value="0" <?= $ptype == 0 ? 'selected="selected"':'' ?>>For Rent</option>
                                            <option value="1" <?= $ptype == 1 ? 'selected="selected"':'' ?>>For Sale</option>
