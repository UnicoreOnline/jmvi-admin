...
$user = $userController->getUserByUserId($reservedProperty->user_id);
$property = $propertyController->getRealEstateByRealEstateId($reservedProperty->property_id);
...
if(!empty($user) && !empty($user->user_id)) {
        ...
        $mail->addAttachment("upload_pic/invoice/".$reservedProperty->invoice);
        $mail->isHTML(true);
        $mail->Subject = "JMVI property";
        $mail->Body = "Hi ".$userName.",<br/><br/>
        Congratulations! You have reserved {$propertyName}. We have attached the invoice for payment. Click <a href='".$payUrl."'>Pay Now</a> to have payment done through PayPal.
        </br><br/><br/>
        Thank you.";
