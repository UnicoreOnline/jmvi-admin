...
if (!empty($_SERVER['QUERY_STRING'])) {
    ...
    if (isset($id) && $id > 0) {
        $bid = $controller->getBidMadeById($id);        
    }
        ...
        <div class="panel-body">
            <div class="row">
                <div class='col-sm-10 col-md-10'>
                    <?php if(isset($bid->invoice) && !empty($bid->invoice)){ ?>
                    <iframe src="<?= $invoiceBaseUrl.$bid->invoice ?>" width='100%' height="500px"></iframe>
                    <?php } ?>
                </div>
                <div class='col-sm-2 col-md-2'>
                    <div class="row">
                        <a class="btn btn-info" target="_blank" href="download_file.php?file=<?= $bid->invoice ?>" role="button">Download</a>
                    ...
                    <div class="row">
                        <?php $mailUrl = $extras->encryptQuery1(KEY_SALT, 'id', $bid->id, 'send_invoice_email_bid.php'); ?>
